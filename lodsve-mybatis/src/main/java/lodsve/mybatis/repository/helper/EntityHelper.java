...
public class EntityHelper {
     ...
     * @return 全部列
     */
    public static Set<ColumnBean> getColumns(Class<?> entityClass) {
     ...
     * @return 主键
     */
    public static IdColumn getIdColumn(Class<?> entityClass) {
        return getEntityTable(entityClass).getIdColumn();
    }
     ...
     * @return 乐观锁的字段
     */
    public static VersionColumn getVersionColumn(Class<?> entityClass) {
        return getEntityTable(entityClass).getVersionColumn();
    }
     ...
     * @return 逻辑删除的字段
     */
    public static DeleteColumn getDeleteColumn(Class<?> entityClass) {
        return getEntityTable(entityClass).getDeleteColumn();
    }
     ...
     * @return 逻辑删除的字段
     */
    public static LastModifiedDateColumn getModifiedDateColumn(Class<?> entityClass) {
        return getEntityTable(entityClass).getModifiedDateColumn();
    }
     ...
     * @return 逻辑删除的字段
     */
    public static LastModifiedByColumn getModifiedByColumn(Class<?> entityClass) {
        return getEntityTable(entityClass).getModifiedByColumn();
    }
     ...
     * @return 逻辑删除的字段
     */
    public static DisabledDateColumn getDisabledDateColumn(Class<?> entityClass) {
        return getEntityTable(entityClass).getDisabledDateColumn();
    }
