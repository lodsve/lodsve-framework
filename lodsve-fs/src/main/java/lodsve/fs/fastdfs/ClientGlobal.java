...
import lodsve.fs.common.IniFileReader;
...
public class ClientGlobal {
     ...
     */
    public static void init(InputStream configFile) throws IOException, FsException {
        IniFileReader iniReader;
        String[] szTrackerServers;
        String[] parts;

        iniReader = new IniFileReader(configFile);
