...
public class PaodingAnalyzer extends PaodingAnalyzerBean {
    ...
    public PaodingAnalyzer(Resource resource) {
        init(resource);
    }
    ...
    protected void init(Resource resource) {
        ...
        if (resource == null) {
            resource = resourceLoader.getResource(PaodingMaker.DEFAULT_PROPERTIES_PATH);
        }
        ...
        try {
            ...
            init(PaodingMaker.DEFAULT_PROPERTIES_PATH);
            return;
        }
