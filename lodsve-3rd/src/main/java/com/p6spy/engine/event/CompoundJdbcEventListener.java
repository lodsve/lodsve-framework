...
public class CompoundJdbcEventListener extends JdbcEventListener {
    ...
    /**
     * Returns a read only view of the registered {@link com.p6spy.engine.event.JdbcEventListener}s
     *
     * @return a read only view of the registered {@link com.p6spy.engine.event.JdbcEventListener}s
     */
