package message.mvc.web.resolver;

import javassist.ClassPool;
import javassist.CtClass;
import javassist.CtMethod;
import javassist.LoaderClassPath;
import message.mvc.web.annotation.Parse;
import message.mvc.web.commons.WebInput;
...
/**
 * 当前台传入类似于1,2,3,4,5之类的字符串，将会被解析成一个List，具体参数在{@link message.mvc.web.annotation.Parse}中配置.
 *
 * @author sunhao(sunhao.java@gmail.com)
 * @version V1.0
 * @createTime 2015-2-9 18:59
 * @see message.mvc.web.annotation.Parse
 */
    ...
    private StringParse generateParseClassBody(Class<?> dest, String parseObjKey) {
        try {
            ...
            if (StringUtils.isEmpty(destClass)) {
                ...
                body.append("return message.utils.NumberUtils.isNumber($1) ? ").append(destClass).append(".valueOf($1) : null;\n");
            }
