 ...
 * allow you to do this.  Flexjson ships with a simple HTML encoder {@link HTMLEncoder}.
 ...
 * {@link JSONSerializer#transform(message.json.Transformer, String[])}, or {@link JSONSerializer#exclude(String[])}
 * from multiple threads at the same time.  It is also NOT safe to use
 * {@link JSONSerializer#serialize(String, Object)} and include/exclude/transform from
...
public class JSONSerializer {
     ...
     * named rootName.  This is great to use in conjunction with other libraries
     * like EXTJS whose data models require them to be wrapped in a JSON object.
     * See {@link JSONSerializer#deepSerialize(Object)} for more
